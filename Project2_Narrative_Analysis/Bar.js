...
d3.csv("./Data/Region_Women_Violence_Rate.csv", d3.autoType).then(data2 => 
    {
...
.domain([0, d3.max(state2.data2, d=>d.Women_Violence_Rate)]) //take 0-1435(max value of count)
...
.append("g")
    ...
    .call(xAxis1)
    .append("text")
  .text("Women Violence in terms  of Region")
...
svg.selectAll("text.Women_Violence_Rate")
      .data(state2.data2)
      .join("text")
      .attr("class", 'Women_Violence_Rate')
